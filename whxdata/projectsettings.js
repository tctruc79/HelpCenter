...
rh = window.rh;
model = rh.model;
var defaultTopic = "SINGAPORE/Managing_your_account/Setting_up_and_managing_your_account/How_to_register_a_login_Profile.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("SINGAPORE/Managing_your_account/Setting_up_and_managing_your_account/How_to_register_a_login_Profile.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.html'));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', '6eef77ea-4adf-4f63-afd5-d517056aef0f' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "TRANSWAP&#39;S HELP CENTRE");
